...
export const ThematicTafsir: React.FC = () => {
  ...
  const attributionText = "Digenerate oleh Juz Amma Global Tafsir AI yang dibuat dan digagas oleh Ustadz Liyas Syarifudin, M. Pd.";
    ...
    const content = `
      ...
      <body>
        <div class="header">
          ...
          <div class="title">Tafsir Tematik Juz Amma</div>
    ...
    container.innerHTML = `
      <div style="font-family: 'Inter', sans-serif; color: #333;">
        <div style="text-align: center; border-bottom: 2px solid #047857; padding-bottom: 15px; margin-bottom: 25px;">
          ...
          <h2 style="color: #333; font-size: 16px; margin: 0; font-weight: bold;">Tafsir Tematik Juz Amma</h2>
    ...
    <div className="max-w-4xl mx-auto px-4 pb-20 -mt-10 relative z-20">
      ...
      <div className="bg-white rounded-2xl shadow-xl p-6 mb-8 border border-slate-100">
        ...
        <div className="relative mb-6">
          <input 
            type="text" 
            placeholder="Ketik tema kajian (misal: Hari Kiamat, Sabar, Rezeki)..."
            value={themeInput}
            onChange={(e) => setThemeInput(e.target.value)}
            onKeyDown={(e) => e.key === 'Enter' && handleGenerate(themeInput)}
            className="w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all"
          />
      ...
      {loading && (
        <div className="text-center py-20">
          ...
          <p className="text-slate-400">AI sedang menelaah seluruh Juz Amma untuk tema ini.</p>
        </div>
      )}
            ...
            <div className="p-8 space-y-8">
              ...
              <section>
                <h3 className="text-emerald-700 font-bold uppercase tracking-wider text-sm mb-4 border-b border-emerald-100 pb-2">
                  Ayat-Ayat Pilihan dalam Juz Amma
                </h3>
