...
export const generateThematicTafsir = async (
  ...
  const prompt = `
    ...
    Batasan: FOKUS HANYA pada ayat-ayat yang terdapat dalam JUZ AMMA (Juz 30, Surah An-Naba s.d. An-Nas).
    Sumber Rujukan: ${source}.
    
    Instruksi:
    1. Pilih 3-5 ayat paling relevan dari Juz Amma yang membahas tema ini.
    ...
    Format JSON:
    - theme: Judul tema
    - introduction: Pengantar singkat tentang tema ini dalam konteks Juz Amma.
